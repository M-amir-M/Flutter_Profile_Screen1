...
class ProfileState extends State<Profile> with SingleTickerProviderStateMixin {
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  GridView.count(
                                    ...
                                    children: <Widget>[
                                      _buildCard(
                                          'وزن', '15.5 kg', Icons.alarm_add, 1),
                                      _buildCard('قد', '70.2 cm',
                                          Icons.arrow_upward, 2),
                                    ],
                                  ),
                                  SizedBox(
                                    height: 10.0,
            ...
            child: ClipPath(
                ...
                child: Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      buildTabbarItem(Icons.toys, 'اتاق بازی', false),
                      buildTabbarItem(Icons.trending_up, 'پیشرفت', false),
                      buildCenterTabbarItem(Icons.home, 'پروفایل', true),
                      buildTabbarItem(Icons.library_books, 'کتابخانه', false),
                      buildTabbarItem(Icons.directions_car, 'سفر', false),
                    ],
                  ),
                )))
      ],
  ...
  Widget buildTabbarItem(icon, String title, bool isActive) {
  ...
  Widget buildCenterTabbarItem(icon, String title, bool isActive) {
    var color = isActive ? redColor : greyColor;
    return Expanded(
        child: InkWell(
